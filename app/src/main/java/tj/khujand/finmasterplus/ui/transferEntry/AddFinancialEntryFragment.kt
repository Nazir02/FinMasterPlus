 ...
 * Use the [AddFinancialEntryFragment.newInstance] factory method to
...
class AddFinancialEntryFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AddFinancialEntryFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AddFinancialEntryFragment().apply {
